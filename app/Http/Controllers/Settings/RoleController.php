...
class RoleController extends Controller
{
    ...
    public function permissionIndex()
    {
        ...
        return view('settings.roles.permission-index', [
    ...
    {
        return view('settings.roles.permission-create');
    }
    ...
    public function permissionEdit(Int $id)
    {
        ...
        return view('settings.roles.permission-edit', [
    ...
    public function roleIndex()
    {
        ...
        return view('settings.roles.role-index', [
            'roles' => $roles,
        ]);
    }
    ...
    {
        return view('settings.roles.role-create');
    }
    ...
    public function roleEdit(Int $id)
    {
        ...
        return view('settings.roles.role-edit', [
            'role' => $role,
        ]);
    }
    ...
    public function rolePermissionIndex()
    {
        ...
        return view('settings.roles.role-permission-index', [
            'roles' => $roles,
        ]);
    }
    ...
    public function rolePermissionCreate()
    {
        ...
        return view('settings.roles.role-permission-create', [
            'roles' => $roles,
            'permissions' => $permissions,
    ...
    public function rolePermissionEdit(Int $id)
    {
        ...
        return view('settings.roles.role-permission-edit', [
            'role' => $role,
            'permissions' => $permissions,
            'permission_groups' => $permission_groups
        ]);
