<div id="saveSOModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="saveSOModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="saveSOModalTitle">Simpan Sales Order Baru</h5>
            ...
            <div class="modal-footer bg-gray-100">
                ...
                <div class="d-flex justify-content-between" data-extra-toggle="confirmation">
                    @php
                        $salesOrders = [
                            ['route' => 'store.SOReguler', 'label' => 'Reguler Offline'],
                            ['route' => 'store.SOHet', 'label' => 'HET Offline'],
