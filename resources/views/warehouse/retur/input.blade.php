            ...
            <div class="dt-responsive table-responsive mb-3 border-none">
                <table class="table table-striped table-bordered nowrap mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-left"  data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $product->category->name }} Rp {{ $product->selling_price }}">
                            ...
                            <td>
                                <form action="{{ route('inputretur.addCart') }}" method="POST"  style="margin-bottom: 5px">
                                    ...
                                    <button type="submit" class="btn btn-primary border-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambah ke daftar pesanan"><i class="far fa-plus me-0"></i></button>
                                </form>
                            </td>
                        </tr>
                        @empty
