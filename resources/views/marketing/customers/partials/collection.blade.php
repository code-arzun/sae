                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('so.invoiceDownload', $order->id) }}"
                                    class="btn bg-warning me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Cetak Dokumen SO">
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-between">
                                ...
                                <a class="btn btn-purple" data-bs-toggle="tooltip" data-bs-placement="top" title="Cetak Dokumen Penyiapan Produk"
