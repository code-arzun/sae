<div id="createExpenditureCategory" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="createExpenditureCategoryLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h3 class="modal-title text-white" id="createExpenditureCategoryLabel">Tambah Kategori Pengeluaran Baru</h3>
