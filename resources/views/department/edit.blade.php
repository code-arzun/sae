                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $department->slug) }}" required readonly>
                                @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn bg-danger" href="{{ route('department.index') }}">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
