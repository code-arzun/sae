    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('employees.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus me-3"></i>Add Employee</a>
                <a href="{{ route('employees.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash me-3"></i>Clear Search</a>
                </div>
            </div>
        </div>
                ...
                <table class="table mb-0">
                    <thead>
                        <tr class="ligth ligth-data">
                            ...
                            <th>@sortablelink('position_id', 'Jabatan')</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="btn bg-info me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="View"
                                        href="{{ route('employees.show', $employee->id) }}"><i class="ri-eye-line me-0"></i>
                                    </a>
                                    <a class="btn bg-success me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Edit"
                                    ...
                                    <form action="{{ route('employees.destroy', $employee->id) }}" method="POST" style="margin-bottom: 5px">
                                        @method('delete')
                                        @csrf
                                        <button type="submit" class="btn bg-warning me-2 border-none" onclick="return confirm('Are you sure you want to delete this record?')" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Delete"><i class="ri-delete-bin-line me-0"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
