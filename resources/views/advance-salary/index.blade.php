    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('advance-salary.create') }}" class="btn btn-primary add-list"><i class="fas fa-plus me-3"></i></i>Create Advance Salary</a>
                <a href="{{ route('advance-salary.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash me-3"></i>Clear Search</a>
                </div>
            </div>
        </div>
                                ...
                                <form action="{{ route('advance-salary.destroy', $advance_salary->id) }}" method="POST" style="margin-bottom: 5px">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn btn-success me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"
                                            href="{{ route('advance-salary.edit', $advance_salary->id) }}""><i class="ri-pencil-line me-0"></i>
                                        </a>
                                        <button type="submit" class="btn btn-warning me-2 border-none" onclick="return confirm('Are you sure you want to delete this record?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
