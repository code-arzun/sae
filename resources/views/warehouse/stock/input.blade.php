                        ...
                        <table class="table mt-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $product->category->name }} || Rp {{ number_format($product->selling_price) }}">
                                    ...
                                    <td>
                                        <form action="{{ route('inputso.addCart') }}" method="POST"  style="margin-bottom: 5px">
                                            ...
                                            <button type="submit" class="btn btn-primary border-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambah"><i class="far fa-plus me-0"></i></button>
                                        </form>
                                    </td>
                                </tr>
                                @empty
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <form action="{{ route('inputstock.updateCart', $item->rowId) }}" method="POST">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-sm btn-success border-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Perbarui"><i class="fas fa-check"></i></button>
                                    </div>
                                </div>
                            </form>
                        </td>
                        ...
                        <td>
                            <a href="{{ route('inputstock.deleteCart', $item->rowId) }}" class="btn btn-warning border-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="fa-solid fa-trash me-0"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
