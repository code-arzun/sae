                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="expense_image">Upload bukti transaksi</label>
                                </div>
                                @error('expense_image')
                        ...
                        <div class=" row align-items-center">
                            ...
                            {{-- <div class="form-group col-md-3">
                                ...
                                <select class="form-control" name="" required>
                                    <option selected="" disabled>-- Pilih Kategori --</option>
                                    @foreach ($cashflowcategories as $cashflowcategory)
                                        @if ($cashflowcategory->cashflowtype->name == 'Pengeluaran')
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn bg-danger" href="{{ route('expense.index') }}">Batalkan</a>
                        </div>
                    </form>
                </div>
            </div>
