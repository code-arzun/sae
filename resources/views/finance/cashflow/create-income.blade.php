                ...
                <div class="row">
                    ...
                    <!-- Nominal -->
                        <div class="form-group col-md-2">
                            ...
                            <input type="number" class="form-control @error('nominal') is-invalid @enderror" id="nominal" name="nominal" value="{{ old('nominal') }}" placeholder="Masukkan nominal pemasukan!" required>
                            @error('nominal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <!-- Keterangan -->
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" value="{{ old('notes') }}" placeholder="Masukkan keterangan pemasukan!">
                            @error('notes')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <!-- Metode -->
                        <div class="form-group col-md-2">
                            ...
                            <div class="col-md d-flex justify-content-between" id="createIncome">
                                <input type="radio" id="incomeTunai" name="method" value="Tunai" hidden>
                                <label class="btn btn-outline-warning tunai w-100 me-1" for="incomeTunai"> Tunai </label>
                                <input type="radio" id="incomeTransfer" name="method" value="Transfer" hidden>
                                <label class="btn btn-outline-success transfer w-100" for="incomeTransfer"> Transfer </label>
                            </div>
                        </div>
                    <!-- Diterima oleh -->
                    ...
                    <!-- Nomor Rekening -->
                        <div class="form-group col-md-3" id="rekeningPartner" style="display: none;">
                            ...
                            <input type="text" class="form-control text-center" id="rekeningPartner" name="rekeningPartner" value="{{ old('rekeningPartner') }}" placeholder="No. Rek. Pengirim">
                        </div>
