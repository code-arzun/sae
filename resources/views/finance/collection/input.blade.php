    ...
    <div class="row">
        ...
        <div class="col-lg-12 d-flex flex-wrap mb-3">
            <div>
                ...
                <a href="{{ route('input.collection') }}" class="badge bg-secondary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Muat Ulang Halaman"><i class="fa fa-refresh mb-1 mt-1"></i></a>
            </div>
            <div>
                ...
                <!-- Total Tagihan -->
                    <div class="form-group col-md-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control text-center bg-white" id="data-due" name="data-due" value="{{ number_format($salesorder->due) }}" readonly>
                        </div>
                    </div>
                <!-- Dibayar oleh -->
                <div class="form-group col-md-2">
                ...
                <!-- Output untuk tagihan -->
                    <div class="form-group col-md">
                        ...
                        <div class="input-group col-md">
                            ...
                            <input type="number" class="form-control text-center font-weight-bold bg-white" id="due" name="due" value="{{ old('due', 0) }}" readonly>
                        </div>
                    </div>
                <!-- Output untuk total akhir -->
                    <div class="form-group col-md">
                        ...
                        <div class="input-group col-md">
                            ...
                            <input type="number" class="form-control text-center font-weight-bold bg-white" id="grandtotal" name="grandtotal" value="{{ old('grandtotal', 0) }}" readonly>
                        </div>
                    </div>
            </div>
