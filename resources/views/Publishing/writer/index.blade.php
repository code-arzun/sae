                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge badge-primary me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="View"
                                        href="{{ route('writer.show', $writer->id) }}" method="get"><i class="ri-eye-line"></i>
                                    </a>
                                    @if (auth()->user()->hasAnyRole('Super Admin', 'Manajer Publishing', 'Admin'))
                                    <a class="badge badge-success me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"
                                    ...
                                    <form action="{{ route('writer.destroy', $writer->id) }}" method="POST">
                                        @method('delete')
                                        @csrf
                                        <a type="submit" class="badge badge-warning border-none" onclick="return confirm('Are you sure you want to delete this record?')" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="ri-delete-bin-line me-0"></i></a>
                                    </form>
                                    @endif
                                </div>
                            </td>
