                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="btn btn-success me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Download"
                                        href="{{ route('backup.download', $file->getFileName()) }}"><i class="fa-solid fa-download me-0"></i>
                                    </a>
                                    <a class="btn btn-danger me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
