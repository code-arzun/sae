                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="btn btn-success text-white me-2">Full Paid</span>
                            </td>
                            <td>
                                <form action="{{ route('pay-salary.destroy', $paySalary->id) }}" method="POST">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn btn-info me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="History" href="{{ route('pay-salary.payHistoryDetail', $paySalary->id) }}">
