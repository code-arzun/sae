<table class="table">
    <thead class="bg-primary text-center">
        <tr>
            ...
            {{-- <th class="text-white" width="160px">Kategori</th> --}}
    ...
    <tbody>
        ...
        <tr>
            <td class="text-center">
                <a href="{{ route('inputso.deleteCart', $item->rowId) }}" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus">
...
{{-- <div class="offset-lg-2">
    <table class="table table-striped nowrap">
        <thead>
            <tr>
                <th><span class="me-3">Total Item</span></th>
                <th><span class="badge bg-info">{{ number_format(count(Cart::content())) }}</span></th>
                <th><span class="me-3">Total Item</span></th>
                <th><span class="badge bg-warning">{{ number_format(Cart::count()) }}</span></th>
                <th class="text-end"><span class="me-3">Subtotal</span></th>
                <th class="text-end"><span class="badge bg-success">Rp {{ number_format(Cart::subtotal()) }}</span></th>
        ...
        <tbody>
            <form action="{{ route('inputso.confirmation') }}" method="POST">
                @csrf
                <tr>
                    <th colspan="4" class="text-end" data-bs-toggle="tooltip" data-bs-placement="top" title="Gunakan titik (.) sebagai pemisah!">Diskon (%)</th>
                    <th>
                        <div class="input-group">
