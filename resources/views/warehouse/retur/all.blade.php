                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Lihat Detail">{{ $retur->invoice_no }}</a>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Lihat Detail">{{ $retur->delivery->invoice_no }}</a>
                            </td>
                            <td>
                            ...
                            <td>
                                @if ($retur->retur_status === 'Diajukan')
                                        <a href="{{ route('retur.proposed')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Buka Halaman Retur Diajukan"
                                        class="badge bg-warning">{{ $retur->retur_status }}</a>
                                    @elseif ($retur->retur_status === 'Disetujui')
                                        <a href="{{ route('retur.approved')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Buka Halaman Retur Disetujui"
                                        class="badge bg-success">{{ $retur->retur_status }}</a>
                                    @elseif ($retur->retur_status === 'Ditolak')
                                        <a href="{{ route('retur.declined')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Buka Halaman Retur Ditolak"
                                        class="badge bg-danger">{{ $retur->retur_status }}</a>
                                    @else
                                        <a href="{{ route('retur.cancelled')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Buka Halaman Retur Dibatalkan"
                                        class="badge bg-danger">{{ $retur->retur_status }}</a>
                                    @endif
                            </td>
                            {{-- @endif --}}
