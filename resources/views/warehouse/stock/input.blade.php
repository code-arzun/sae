            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <form action="{{ route('inputstock.updateCart', $item->rowId) }}" method="POST">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-sm btn-success border-none" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="Perbarui"><i class="fas fa-check"></i></button>
                                    </div>
                                </div>
                            </form>
                        </td>
                        ...
                        <td>
                            <a href="{{ route('inputstock.deleteCart', $item->rowId) }}" class="btn btn-warning border-none" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="Delete"><i class="fa-solid fa-trash me-0"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
