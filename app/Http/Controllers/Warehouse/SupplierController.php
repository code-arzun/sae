...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return Redirect::route('warehouse.suppliers.index')->with('success', 'Supplier has been created!');
    }
    ...
    {
        return view('warehouse.suppliers.show', [
            'supplier' => $supplier,
        ]);
    }
    ...
    {
        return view('warehouse.suppliers.edit', [
            'supplier' => $supplier
        ]);
    }
    ...
    public function update(Request $request, Supplier $supplier)
    {
        ...
        return Redirect::route('warehouse.suppliers.index')->with('success', 'Supplier has been updated!');
    }
    ...
    public function destroy(Supplier $supplier)
    {
        ...
        return Redirect::route('warehouse.suppliers.index')->with('success', 'Supplier has been deleted!');
    }
}
