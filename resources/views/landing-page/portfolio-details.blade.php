...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/landing-page/img/favicon.png" rel="icon">
  <link href="assets/landing-page/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <!-- <img src="assets/landing-page/img/logo.png" alt=""> -->
        ...
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide">
              <img src="assets/landing-page/img/portfolio/app-1.jpg" alt="">
            </div>

            <div class="swiper-slide">
              <img src="assets/landing-page/img/portfolio/product-1.jpg" alt="">
            </div>

            <div class="swiper-slide">
              <img src="assets/landing-page/img/portfolio/branding-1.jpg" alt="">
            </div>

            <div class="swiper-slide">
              <img src="assets/landing-page/img/portfolio/books-1.jpg" alt="">
            </div>
          ...
          <div class="col-lg-8" data-aos="fade-up">
            <div class="portfolio-description">
              ...
              <div class="testimonial-item">
                ...
                <div>
                  <img src="assets/landing-page/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
                  <h3>Sara Wilsson</h3>
                  <h4>Designer</h4>
                </div>
              </div>
