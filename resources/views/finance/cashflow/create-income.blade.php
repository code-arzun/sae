            ...
            <div class="modal-body bg-gray-100">
                <form action="{{ route('cashflow.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <!-- Metode -->
                        <div class="form-group col-md-2">
                            <label for="method">Metode Transaksi</label>
                            <div class="col-md d-flex justify-content-between">
                                <input type="radio" id="tunai" name="method" value="Tunai" hidden>
                                <label class="btn btn-outline-warning tunai w-100 me-1" for="tunai"> Tunai </label>
                                <input type="radio" id="transfer" name="method" value="Transfer" hidden>
...
<script>
    ...
    const paymentMethodInput = document.querySelector('input[name="method"]:checked');
