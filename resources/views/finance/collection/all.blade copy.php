                        ...
                        <tr>
                            ...
                            <td>
                                <a class="badge badge-primary" href="{{ route('so.orderDetails', $salesorder->id) }}" 
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Lihat Detail">{{ $salesorder->invoice_no }}
                                </a>
                            </td>
                            <td>
                            ...
                            <td>
                                @if ($salesorder->payment_status === 'Belum dibayar')
                                    <a href="{{ route('collection.unpaid')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Buka Halaman Collection Belum dibayar"
                                    class="badge bg-danger">{{ $salesorder->payment_status }}</a>
                                @elseif ($salesorder->payment_status === 'Belum Lunas')
                                    <a href="{{ route('collection.onProgress')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Buka Halaman Collection Belum Lunas"
                                    class="badge bg-warning">{{ $salesorder->payment_status }}</a>
                                @else
                                    <a href="{{ route('collection.paid')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Buka Halaman Collection Lunas"
