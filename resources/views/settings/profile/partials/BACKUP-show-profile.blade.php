...
<div class="card-body">
    ...
    <div class=" row align-items-center">
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control bg-white" id="fname" value="{{  auth()->user()->employee->name }}" readonly>
        </div>
        <div class="form-group col-md-12">
            <label for="fname">Alamat</label>
            <input type="text" class="form-control bg-white" id="fname" value="{{  auth()->user()->employee->address }}" readonly>
        </div>
