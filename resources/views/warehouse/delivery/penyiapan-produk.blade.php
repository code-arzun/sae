                        ...
                        <tr>
                            ...
                            <td>
                                <a class="badge badge-primary" href="{{ route('so.orderDetails', $prepare->id) }}" 
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Lihat Detail">{{ $prepare->invoice_no }}</a>
                            </td>
                            ...
                            <td>
                                <a class="btn btn-warning me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Cetak"
