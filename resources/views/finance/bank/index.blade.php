    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Bank</h4>
                </div>
                <div>
                <a href="{{ route('bank.create') }}" class="btn btn-primary add-list"><i class="fas fa-plus me-3"></i>Tambah Bank</a>
                <a href="{{ route('bank.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash me-3"></i>Hapus Pencarian</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" id="search" class="form-control" name="search" placeholder="Search bank" value="{{ request('search') }}">
            ...
            <div class="dt-responsive table-responsive mb-3">
                <table class="table mb-0">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>@sortablelink('name', 'Nama Bank')</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-success me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Edit"
                                        href="{{ route('bank.edit', $bank->id) }}"><i class="ri-pencil-line me-0"></i>
                                    </a>
