    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('productcategory.create') }}" class="btn btn-primary add-list"><i class="fas fa-plus me-3"></i>Create Category</a>
                <a href="{{ route('productcategory.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash me-3"></i>Clear Search</a>
                </div>
            </div>
        </div>
                ...
                <table class="table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>@sortablelink('productunit_id', 'Satuan')</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $category->name }}</td>
                            <td>{{ $category->productunit->name }}</td>
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-success me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"
                                        href="{{ route('productcategory.edit', $category->id) }}"><i class="ri-pencil-line me-0"></i>
                                    </a>
