                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="badge badge-primary" href="{{ route('do.deliveryDetails', $sent->id) }}" 
                                data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Lihat Detail">{{ $sent->invoice_no }}</a></td>
                            <td>
                            ...
                            <td><a class="badge badge-success" href="{{ route('so.orderDetails', $sent->order_id) }}" 
                                data-bs-toggle="tooltip" data-bs-placement="top" title="" title="Lihat Detail">{{ $sent->salesorder->invoice_no }}</a></td>
