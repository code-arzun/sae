<div id="delivered{{ $delivery->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="deliveredTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h5 class="modal-title text-white" id="deliveredTitle">Perbarui Status Delivery Order</h5>
        ...
        <div class="modal-body">
            <div class="d-flex justify-content-between">
                ...
                <form action="{{ route('do.deliveredStatus') }}" method="POST" class="confirmation-form">
                    ...
                    <button class="btn btn-light-success w-100"><i class="fa fa-check me-2"></i>Terkirim</button>
                </form>
            </div>
        </div>
      </div>
